...
const Subcate = () => {
  ...
  return (
    <>
        <div className="text-14 font-400 flex items-center justify-center p-2 lg:flex-row">
          <div className="space-x-4">
            <div className=' lg:block space-x-20'>
              <a href="#" className="text-black hover:text-main hover:font-bold px-2 rounded-full px-1 py-1 text-sm">Drink</a>
              <a href="#" className="text-black hover:text-main hover:font-bold px-2 rounded-full px-1 py-1 text-sm">Alcohol</a>
              <a href="#" className="text-black hover:text-main hover:font-bold px-2 rounded-full px-1 py-1 text-sm">Snack</a>
              <a href="#" className="text-black hover:text-main hover:font-bold px-2 rounded-full px-1 py-1 text-sm">Dessert</a>
            </div>
          </div>     
        </div>
    </>
